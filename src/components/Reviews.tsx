...
function ReviewColumn({
  ...
  return (
    <div
      ...
      className={cn(
        "space-y-8 py-4",
        columnHeight > 0 && "animate-marquee",
        className,
      )}
...
function Review({
  ...
  const animationDelay =
    POSSIBLE_ANIMATION_DELAYS[index % POSSIBLE_ANIMATION_DELAYS.length];
...
function ReviewGrid() {
  ...
  const columns = splitArray(REVIEW_SCREENS, 3);
