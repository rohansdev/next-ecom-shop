...
const CoverDesigner = ({
  ...
  const [options, setOptions] = useState<{
    ...
    finish: (typeof FINISHING.options)[number];
  }>({
    color: COLORS[0],
    ...
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-896/1831">
          ...
          <div className="absolute z-50 inset-0 left-0.75 top-px right-0.75 bottom-px rounded-[32px] shadow-[0_0_0_99999px_rgba(229,231,235,0.6)]" />
          <div
            className={cn(
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="relative flex flex-col gap-3 w-full">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent>
                      <DropdownMenuGroup>
                        <DropdownMenuLabel>My iPhone</DropdownMenuLabel>
                ...
                {[MATERIALS, FINISHING].map(
                  ({ name, options: selectableOpt }) => (
                    <RadioGroup
                      key={name}
                      value={options[name]}
                      onChange={(val) => {
